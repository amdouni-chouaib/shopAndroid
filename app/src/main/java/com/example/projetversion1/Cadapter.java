...
public class Cadapter extends FirebaseRecyclerAdapter<Product,Cadapter.viewHolder>{

    public Cadapter(@NonNull FirebaseRecyclerOptions<Product> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull Cadapter.viewHolder holder, int position, Product model) {
    ...
    class viewHolder extends  RecyclerView.ViewHolder{
        ...
        public viewHolder(@NonNull View itemView) {
            ...
            img.setOnClickListener(new View.OnClickListener() {
                ...
                DatabaseReference mDbRef = mDatabase.getReference("random/female/clothes");
                @Override
