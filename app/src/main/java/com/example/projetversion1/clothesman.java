...
public class clothesman extends FirebaseRecyclerAdapter<Product,clothesman.viewHolder>{

    public clothesman(@NonNull FirebaseRecyclerOptions<Product> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull clothesman.viewHolder holder, int position, Product model) {
    ...
    @NonNull
    @Override
    public clothesman.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.clothes,parent,false);
        return new clothesman.viewHolder(view);
    }
    ...
    class viewHolder extends  RecyclerView.ViewHolder{
        ...
        public viewHolder(@NonNull View itemView) {
            super(itemView);
            Title = itemView.findViewById(R.id.nomss);
            img = itemView.findViewById(R.id.imag);

            img.setOnClickListener(new View.OnClickListener() {
                FirebaseDatabase mDatabase = FirebaseDatabase.getInstance();
                DatabaseReference mDbRef = mDatabase.getReference("random/male/clothes");
                @Override
