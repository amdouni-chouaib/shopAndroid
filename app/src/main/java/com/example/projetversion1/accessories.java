...
public class accessories extends FirebaseRecyclerAdapter<Product,accessories.viewHolder>{

    public accessories(@NonNull FirebaseRecyclerOptions<Product> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull accessories.viewHolder holder, int position, Product model) {
    ...
    @NonNull
    @Override
    public accessories.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bag,parent,false);
        return new accessories.viewHolder(view);
    }
    ...
    class viewHolder extends  RecyclerView.ViewHolder{
        ...
        public viewHolder(@NonNull View itemView) {
            ...
            img.setOnClickListener(new View.OnClickListener() {
                ...
                DatabaseReference mDbRef = mDatabase.getReference("random/female/accessories");
                @Override
