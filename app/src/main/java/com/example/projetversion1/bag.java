...
public class bag extends FirebaseRecyclerAdapter<Product,bag.viewHolder>{

    public bag(@NonNull FirebaseRecyclerOptions<Product> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull bag.viewHolder holder, int position, Product model) {
    ...
    @NonNull
    @Override
    public bag.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bag,parent,false);
        return new bag.viewHolder(view);
    }
    ...
    class viewHolder extends  RecyclerView.ViewHolder{
        ...
        public viewHolder(@NonNull View itemView) {
            ...
            img.setOnClickListener(new View.OnClickListener() {
                ...
                DatabaseReference mDbRef = mDatabase.getReference("random/female/bag");
                @Override
