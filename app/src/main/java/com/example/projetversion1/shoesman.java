...
public class shoesman extends FirebaseRecyclerAdapter<Product,shoesman.viewHolder>{

    public shoesman(@NonNull FirebaseRecyclerOptions<Product> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull shoesman.viewHolder holder, int position, Product model) {
    ...
    @NonNull
    @Override
    public shoesman.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.shoes,parent,false);
        return new shoesman.viewHolder(view);
    }
    ...
    class viewHolder extends  RecyclerView.ViewHolder{
        ...
        public viewHolder(@NonNull View itemView) {
            super(itemView);
            Title = itemView.findViewById(R.id.re);
            img = itemView.findViewById(R.id.pic);

            img.setOnClickListener(new View.OnClickListener() {
                FirebaseDatabase mDatabase = FirebaseDatabase.getInstance();
                DatabaseReference mDbRef = mDatabase.getReference("random/male/shoes");
                @Override
