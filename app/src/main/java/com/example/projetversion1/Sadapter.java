...
public class Sadapter extends FirebaseRecyclerAdapter<Product,Sadapter.viewHolder>{

    public Sadapter(@NonNull FirebaseRecyclerOptions<Product> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull Sadapter.viewHolder holder, int position, Product model) {
    ...
    class viewHolder extends  RecyclerView.ViewHolder{
        ...
        public viewHolder(@NonNull View itemView) {
            ...
            img.setOnClickListener(new View.OnClickListener() {
                ...
                DatabaseReference mDbRef = mDatabase.getReference("random/female/shoes");
                @Override
